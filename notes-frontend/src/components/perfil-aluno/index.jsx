...
export default function PerfilAluno() {
  ...
  // abas: se não for professor, só info e foto
  const [activeTab, setActiveTab] = React.useState("info"); // "info" | "historico" | "foto"

  // factories dinâmicos (professor)
  const emptyExperience = () => ({ titulo: "", descricao: "", inicio: "", fim: "", link: "" });
  ...
  const [notif, setNotif] = React.useState({
    push: true, email: true, timesheets: true, leaves: true, documents: true, digest: false,
  });
  ...
  async function handleSave(e) {
    ...
    try {
      ...
      if (form.modalidades !== undefined) patch.modalidades = form.modalidades;
        ...
        <div className="perfil-container">
          ...
          <section className="main-card card">
            <header className="perfil-header">
              <h1>Meu Perfil</h1>
              <p>Gerencie suas informações, {isProfessor ? "histórico" : "bio"} e foto.</p>
              {publicUrl && (
            ...
            <div className="tabs">
              ...
              {/* Aba HISTÓRICO só para professor */}
              {isProfessor && (
                <button
              ...
              <button
                className={`tab ${activeTab === "foto" ? "active" : ""}`}
            ...
            {(err || ok) && (
              <div className={`alert ${err ? "alert--error" : "alert--ok"}`}>{err || ok}</div>
            )}
            ...
            {loading ? (
              ...
              <>
                ...
                {activeTab === "info" && (
                  <form onSubmit={handleSave} className="form form-2col">
                    ...
                    <div className="field">
                      ...
                      <small className="hint">O e-mail é gerenciado na seção de Segurança.</small>
                    </div>
                    <div className="field">
                    ...
                    {isProfessor ? (
                      <>
                        <hr className="sep span-2" />
                        <h3 className="subsection span-2">Informações de Professor</h3>
                        ...
                        <div className="field">
                          <label htmlFor="especializacoes">Habilidades / Especializações</label>
                        ...
                        <div className="field span-2">
                          <label htmlFor="historico_academico_profissional">Resumo</label>
                          <textarea id="historico_academico_profissional" name="historico_academico_profissional" value={form.historico_academico_profissional || ""} onChange={handleChange} rows={4} placeholder="Formação, experiência, conquistas..." />
                        </div>
                        ...
                        <div className="field">
                          <label htmlFor="disponibilidade_dias">Dias disponíveis</label>
                          <input id="disponibilidade_dias" name="disponibilidade_dias" value={form.disponibilidade_dias || ""} onChange={handleChange} placeholder="Segunda, Terça, ..." />
                        </div>
                        <div className="field">
                          <label htmlFor="disponibilidade_horarios">Horários disponíveis</label>
                      ...
                      <>
                        <hr className="sep span-2" />
                        <h3 className="subsection span-2">Sobre você</h3>

                        <div className="field span-2">
                          <label htmlFor="bio">Bio</label>
                          <textarea id="bio" name="bio" value={form.bio} onChange={handleChange} rows={4} placeholder="Conte um pouco sobre você..." />
                        </div>
                        ...
                        <div className="field">
                          <label htmlFor="quer_aprender">Quero aprender</label>
                ...
                {/* ====== HISTÓRICO (apenas professor) ====== */}
                {isProfessor && activeTab === "historico" && (
                  ...
                  <div className="foto-wrap">
                    ...
                    <div className="foto-actions">
                      <label className="btn btn--outline" htmlFor="avatarInput">
                        {avatarSaving ? "Enviando..." : "Selecionar nova foto"}
                      </label>
                      <input id="avatarInput" type="file" accept="image/*" onChange={handlePickAvatar} hidden />
                    </div>
                    <p className="hint">Use uma imagem quadrada. PNG/JPG até 2MB.</p>
                  </div>
                )}
              </>
            )}
          ...
          {/* SEGURANÇA */}
          <section className="card security-block">
